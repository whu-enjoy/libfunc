/*************************************************************************
    ...
    > Created Time    : 2017年03月15日 星期三 10时40分24秒
    > Version         : 1.0
    > Description     : 
    > Function List   : 
    > History         : 
...
/************************************************************************
    > Function       : int getRandData(char funcName[])
...
int getRandData(char funcName[])
{
    ...
    while (1)
    {
        ...
        fprintf(stdout, "*************** 欢迎使用 ***************\n");
        fprintf(stdout, "****************************************\n");
        fprintf(stdout, "** 输入1,getRandData /*获取随机数列*/ **\n");
